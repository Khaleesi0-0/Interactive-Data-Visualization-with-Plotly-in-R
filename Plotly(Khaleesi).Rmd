...
Here’s a customized scatterplot using `mtcars`.
We’ll:
...
1. **Filtering the data before plotting**
   Using `dplyr::filter()`, you can focus on a subset of the data (e.g., only cars with high MPG, or only 4-cylinder cars). This makes your interactive plot more targeted.

2. **Zooming and panning inside Plotly**
   Once the plot is rendered, you can:
